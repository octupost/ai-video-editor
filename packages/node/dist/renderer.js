...
export class Renderer extends EventEmitter {
    ...
    async render() {
        ...
        try {
            ...
            await this.page.addInitScript((jsonData) => {
            ...
            this.page.on('requestfailed', (req) => console.log(`[BROWSER NETWORK FAIL] ${req.url()} - ${req.failure()?.errorText}`));
            this.emitProgress({
                progress: 0.2,
                phase: 'rendering',
            ...
            await this.page.exposeFunction('__reportProgress', (progress) => {
                this.emitProgress({
