...
export class AudioClip extends BaseClip implements IPlaybackCapable {
  ...
  static async fromUrl(
    ...
    const clip = new AudioClip(response.body!, opts, url);
    await clip.ready;
    return clip;
  }
  ...
  async clone() {
    await this.ready;
    const clip = new AudioClip(this.getPCMData(), this.opts, this.src) as this;
    await clip.ready;
  ...
  toJSON(main: boolean = false): AudioClipJSON {
