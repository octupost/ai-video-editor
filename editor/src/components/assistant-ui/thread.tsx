...
import { AddTextTool } from '@/components/assistant-ui/tools/add-text-tool';
import { DeleteSelectedTool } from '@/components/assistant-ui/tools/delete-selected-tool';
import { DuplicateSelectedTool } from '@/components/assistant-ui/tools/duplicate-selected-tool';
import { SplitSelectedTool } from '@/components/assistant-ui/tools/split-selected-tool';
      ...
      {[
        {
          ...
          label: 'from your computer or link',
          action: 'Help me import media assets',
        },
        {
          title: 'Add a transition',
          label: 'between the first two clips',
          action: 'Add a cross-fade transition between the first two clips',
        },
        {
          title: 'Generate captions',
          label: 'for the spoken audio',
          action: 'Generate captions for the timeline',
        },
        {
          title: 'Add background music',
          label: 'lo-fi hip hop beat',
          action: 'Add lo-fi hip hop background music',
        },
          ...
          <MessagePrimitive.Parts
            components={{
              ...
              tools: {
                ...
                by_name: {
                  add_text: AddTextTool,
                  delete_selected: DeleteSelectedTool,
                  duplicate_selected: DuplicateSelectedTool,
                  split_selected: SplitSelectedTool,
